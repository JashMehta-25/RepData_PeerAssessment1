...
## Analysis of the U.S. National Oceanic and Atmospheric Administrations (NOAA) storm database  
...
# reading data
Raw_data <- read.csv("G:/datasciencecoursera/RepData_PeerAssessment1/repdata_data_StormData.csv.bz2", header=TRUE, sep=",")
```
...
- [Mentors comments in the Discussion Forum on the Course web-site](https://www.coursera.org/learn/reproducible-research/discussions/weeks/4/threads/IdtP_JHzEeaePQ71AQUtYw)  
